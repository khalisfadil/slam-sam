    ...
    auto gtsam_thread = std::thread([&registerCallback, &dataQueue, &vizQueue]() {
        ...
        try {
            while (running) {
                ...
                auto insData = data_frame->ins;
                auto insSize = insData.size();
                auto insFront = insData.front();
                auto accelXFront = insFront.accelX_28;
                auto accelXFront = insFront.accelY_28;
                auto accelXFront = insFront.accelZ_28;
                auto accelXFront = insFront.gyroX_28;
                auto accelXFront = insFront.gyroY_28;
                auto accelXFront = insFront.gyroZ_28;
                auto accelXFront = insFront.magX_28;
                auto accelXFront = insFront.magY_28;
                auto accelXFront = insFront.magZ_28;
                auto accelXFront = insFront.gyroX_28;
                ...
                //     bool is_gps_available_now = (insChecker < 0.1);
