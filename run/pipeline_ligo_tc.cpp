...
int main() {
    ...
    auto gtsam_thread = std::thread([&registerCallback, &compCallback, &dataQueue, &vizQueue]() {
        ...
        const double ins_recovery_rate = 0.001; // Trust regained over 1/0.02 = 50 keyframes
        ...
        const double gnss_recovery_rate = 0.001; // Trust regained over 1/0.02 = 50 keyframes
