...
int main() {
    ...
    auto gtsam_thread = std::thread([&registerCallback, &compCallback, &dataQueue, &vizQueue]() {
        ...
        const double ins_recovery_rate = 0.01; // Trust regained over 1/0.02 = 50 keyframes
        ...
        const double gnss_recovery_rate = 0.01; // Trust regained over 1/0.02 = 50 keyframes
                ...
                *pointsBody = std::move(data_frame->points.pointsBody);
                ...
                if (is_first_keyframe) {
                    ...
                    // if (insValid){
                        ...
                        bool is_ins_available_now = (insChecker < 0.09);
